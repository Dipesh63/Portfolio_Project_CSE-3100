...
<body>
  ...
  <script>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    – Marc Riboud
                        ...
                        <div class="slider">
                            <asp:Image ID="Image1" runat="server" Width="460px" Height="380px" />
                            <br />
                            <asp:Button ID="BackButton" runat="server" Text="See Next Photograph" OnClick="BackButton_Click"  style=""   />
                            <asp:Button ID="ForwardButton" runat="server" Text="See Photograph Deatils" OnClick="ForwardButton_Click" />
                        </div>
                    </section>
                </ContentTemplate>
            </asp:UpdatePanel>
    ...
    <form action="">
        ...
        <asp:TextBox ID="TextBox1" runat="server" style="margin-top:14px;font-size: 16px;width: 300px; height: 40px;"></asp:TextBox><br />

                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter the usename" ControlToValidate="TextBox1"></asp:RequiredFieldValidator>
        ...
        <asp:TextBox ID="TextBox2" runat="server"  style="margin-top:14px;font-size: 16px;width: 300px; height: 40px;"></asp:TextBox><br />
        ...
        <asp:Button ID="Button2" runat="server" Text="Logout" style=" cursor: pointer;  margin-top:14px;font-size: 16px;width:140px;height:40px; background-color:red;color:black;  margin-left:8px; transition: color 0.3s;" /><br />
                <a href="register.aspx" style="margin-top:22px;font-size: 20px; text-decoration:none;    transition: color 0.3s; ">Don't have an account yet?  Sign Up</a>  
                 </div>
    </section>
    </div>

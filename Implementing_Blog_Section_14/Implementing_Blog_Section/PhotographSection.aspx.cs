...
namespace Implementing_Blog_Section
{
    public partial class PhotographSection : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            // Construct the URL for imagedetails.aspx with the current image ID as a query string parameter
            string url = "~/imagedetails.aspx?ImageId=" + currentImageId;

            // Register a script to open a new tab with the specified URL
            ClientScript.RegisterStartupScript(this.GetType(), "OpenWindow", "window.open('" + ResolveUrl(url) + "', '_blank');", true);
